...
export default function InteriorPage() {
  const disciplines = [
    {
      icon: FaHome,
      title: 'Luxury Residential & Penthouse Interiors',
      desc: 'Bespoke living environments tailored for ultra-high-net-worth residences in Gulshan, Banani, and Dhanmondi.',
      badge: 'Bespoke Living',
    },
    {
      icon: FaCube,
      title: 'Architectural Joinery & Custom Millwork',
      desc: 'Handcrafted solid oak, fluted walnut paneling, concealed pivot doors, and custom-built walk-in wardrobes.',
      badge: 'Handcrafted Wood',
    },
    {
      icon: FaLightbulb,
      title: 'Circadian Architectural Lighting Design',
      desc: 'Concealed LED cove illumination, low-glare magnetic track lights, and automated scene dimming calibrated to natural daylight.',
      badge: 'Circadian Lighting',
    },
    {
      icon: FaGem,
      title: 'Luxury Marble & Natural Stone Masonry',
      desc: 'Book-matched Calacatta and Statuario Italian marble waterfall kitchen islands, vanity slabs, and seamless porcelain flooring.',
      badge: 'Italian Marble',
    },
    {
      icon: FaVolumeMute,
      title: 'Acoustic Balancing & Audio Isolation',
      desc: 'Micro-perforated acoustic timber walls, silent HVAC slot diffusers, and multi-layered soundproofing for private study suites and home theaters.',
      badge: 'Acoustic Isolation',
    },
    {
      icon: FaSlidersH,
      title: 'Smart Home Environmental Automation',
      desc: 'Integrated control of climate, automated sheer drapery, multi-zone soundscapes, and bioclimatic air quality monitoring.',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            >
              ...
              Discipline · Interior Architecture & Design
            </motion.div>
            ...
            >
              We sculpt interior environments where natural textures, diffused lighting, and acoustic serenity unite into luxurious, harmonious living sanctuaries.
            </motion.p>
            ...
            >
              ...
              >
                Schedule Interior Consultation <FaArrowRight className="w-3.5 h-3.5" />
              </Link>
              <Link
                href="/properties"
          ...
          >
            <div className="relative rounded-3xl overflow-hidden border border-white/15 shadow-2xl h-[420px] sm:h-[500px]">
              <Image
                src="/image/services/interior.jpg"
                alt="Luxury Penthouse Interior by Monsi"
                fill
                priority
              ...
              <div className="bottom-6 left-6 right-6 absolute">
                ...
                <h3 className="mt-2 font-bold text-white text-xl">The Lakeview Penthouse</h3>
                <p className="text-gray-300 text-xs mt-0.5">Dhanmondi, Dhaka · Fluted Walnut & Calacatta Marble</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-3 text-gray-400 text-sm sm:text-base">
              Customized design, imported material procurement, and master craftsmanship.
            </p>
          </div>
            ...
            {disciplines.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-6 pt-4 border-t border-white/5 flex items-center gap-1.5 text-xs font-semibold text-[#0C969C]">
                    <FaCheckCircle className="w-3 h-3" /> Turnkey Material & Execution
                  </div>
                </motion.div>
              );
            })}
      ...
      <section className="relative z-10 py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="bg-gradient-to-r from-[#033030] via-[#021f20] to-[#033030] shadow-2xl p-8 sm:p-12 border border-white/15 rounded-3xl text-center">
          <h2 className="font-bold text-3xl sm:text-4xl text-white">
            Ready to Reimagine Your Interior Space?
          </h2>
          <p className="mt-3 text-gray-300 text-sm max-w-xl mx-auto">
            Book an exclusive design consultation with our lead interior architects.
          </p>
